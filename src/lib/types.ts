...
export type Industry = 'Bank' | 'FinTech' | 'Vertical SaaS' | 'Health Tech' | 'SaaS' | 'AI' | 'MarTech' | 'Payments' | 'Crypto' | 'Cyber';
...
export const INDUSTRIES: Industry[] = ['Bank', 'FinTech', 'Vertical SaaS', 'Health Tech', 'SaaS', 'AI', 'MarTech', 'Payments', 'Crypto', 'Cyber'];
