...
export type Industry = 'Bank' | 'FinTech' | 'Tech' | 'Health Tech' | 'SaaS' | 'AI' | 'RETech' | 'MarTech' | 'Payments' | 'Crypto';
...
export const INDUSTRIES: Industry[] = ['Bank', 'FinTech', 'Tech', 'Health Tech', 'SaaS', 'AI', 'RETech', 'MarTech', 'Payments', 'Crypto'];
